...
bash "$HERE/install/configure-remove-default-user.sh"
bash "$HERE/install/configure-kernel-cmdline.sh"
bash "$HERE/install/configure-timezone.sh"
bash "$HERE/install/configure-hostname.sh"
bash "$HERE/install/configure-network-dispatcher.sh"
